...
// static char font[] = "Inconsolata:pixelsize=13:lcdfilter=lcddefault:hintstyle=hintfull:hinting=true:rgba=rgb:antialias=true:autohint=false";
...
static const char *colorname[] = {
    ...
    "#111111",  /* 256: background */
    "#b4b4b4",  /* 257: foreground */
    "#ffaf00",  /* 258: cursor */
};
